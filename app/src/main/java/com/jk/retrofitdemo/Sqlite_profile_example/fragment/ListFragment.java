...
import com.jk.retrofitdemo.Sqlite_profile_example.adapter.ListFragmentAdapter;
...
public class ListFragment extends Fragment {
    ...
    ListFragmentAdapter mListFragmentAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        listfragment = databaseHandler.taskjoin(task_name);

        listrecyclerview = view.findViewById(R.id.list_recyclerview);
        RecyclerView.LayoutManager  layoutManager=new LinearLayoutManager(getActivity());
        listrecyclerview.setLayoutManager(layoutManager);

        mListFragmentAdapter = new ListFragmentAdapter(getContext(),listfragment);
        listrecyclerview.setAdapter(mListFragmentAdapter);

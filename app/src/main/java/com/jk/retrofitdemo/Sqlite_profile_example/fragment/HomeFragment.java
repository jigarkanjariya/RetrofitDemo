...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mTvNavName = view.findViewById(R.id.tv_navigationname);
        mBtnGotolist = view.findViewById(R.id.btn_gotolist);
        mTvNavName.setText(task_name);
        mBtnGotolist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                android.support.v4.app.FragmentTransaction ft = getFragmentManager().beginTransaction();
                ListFragment updateFragment = new ListFragment();
